...
<?php ($hook = get_hook('aop_setup_pre_pagination_fieldset_end')) ? eval($hook) : null; ?>
				...
				<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Hide tag legend'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Hide tag legend'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Karma treshold for hide tag'] ?></span><small><?php echo $lang_admin_settings['Karma treshold hide tag help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[nya_hide_treshold]" size="5" maxlength="3" value="<?php echo $forum_config['o_nya_hide_treshold'] ?>" /></span>
						</div>
					</div>
				</fieldset>
	...
	<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['New member to member legend'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Karma treshold for member group'] ?></span><small><?php echo $lang_admin_settings['Karma treshold member group help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[nya_new_member_treshold]" size="5" maxlength="3" value="<?php echo $forum_config['o_nya_new_member_treshold'] ?>" /></span>
						</div>
					</div>
	<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Minus karma weight'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Minus karma weight'] ?></span><small><?php echo $lang_admin_settings['Minus karma weight help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[nya_minus_karma_weight]" size="5" maxlength="3" value="<?php echo $forum_config['o_nya_minus_karma_weight'] ?>" /></span>
						</div>
					</div>
					<h2 class="hn"><span><?php echo $lang_admin_settings['Prevent from posting'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Prevent from posting'] ?></span><small><?php echo $lang_admin_settings['Prevent from posting help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[nya_minus_karma_weight]" size="5" maxlength="3" value="<?php echo $forum_config['karma_post_stop'] ?>" /></span>
						</div>
					</div>					

<?php ($hook = get_hook('aop_setup_pre_pagination_fieldset_end2')) ? eval($hook) : null; ?>
				</fieldset>
				
				<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Gimbo forum id'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Gimbo forum id'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Id of gimbo forum'] ?></span><small><?php echo $lang_admin_settings['Gimbo forum id help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[guest_forum]" size="5" maxlength="3" value="<?php echo $forum_config['o_guest_forum'] ?>" /></span>
						</div>
					</div>
				</fieldset>
				...
				<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Escrow settings'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Escrow settings'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Minimum escrow value'] ?></span><small><?php echo $lang_admin_settings['Minimum escrow value help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[minimum_escrow_value]" size="5" maxlength="8" value="<?php echo $forum_config['o_minimum_escrow_value'] ?>" /></span>
						</div>
					</div>
					
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Escrow duration'] ?></span><small><?php echo $lang_admin_settings['Escrow duration help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[escrow_duration]" size="5" maxlength="3" value="<?php echo $forum_config['o_escrow_duration'] ?>" /></span>
						</div>
					</div>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Empty escrow duration'] ?></span><small><?php echo $lang_admin_settings['Empty escrow duration help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[empty_escrow_duration]" size="5" maxlength="3" value="<?php echo $forum_config['o_empty_escrow_duration'] ?>" /></span>
						</div>
					</div>
				</fieldset>
				
			<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Market settings'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Market settings'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Market category index'] ?></span><small><?php echo $lang_admin_settings['Market category index help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[trade_category_id]" size="5" maxlength="3" value="<?php echo $forum_config['o_trade_category_id'] ?>" /></span>
						</div>
					</div>
				</fieldset>
				...
				<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Problem forums settings'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Problem forums settings'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Current problems forum id'] ?></span><small><?php echo $lang_admin_settings['Problem forum id help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[problem_forum_id]" size="5" maxlength="3" value="<?php echo $forum_config['o_problem_forum_id'] ?>" /></span>
						</div>
					</div>
				</fieldset>
				...
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Archive problem forum id'] ?></span><small><?php echo $lang_admin_settings['Archive problem forum id help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[problem_archive_id]" size="5" maxlength="3" value="<?php echo $forum_config['o_problem_archive_id'] ?>" /></span>
						</div>
					</div>
<?php ($hook = get_hook('aop_setup_pre_pagination_fieldset_end2')) ? eval($hook) : null; ?>				
				</fieldset>
				...
				<div class="content-head">
					<h2 class="hn"><span><?php echo $lang_admin_settings['Commission settings'] ?></span></h2>
				</div>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_settings['Commission settings'] ?></strong></legend>
<?php ($hook = get_hook('aop_setup_pre_topic_review2')) ? eval($hook) : null; ?>
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Regular commission value'] ?></span><small><?php echo $lang_admin_settings['Regular commission value help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[regular_commission_value]" size="5" maxlength="3" value="<?php echo $forum_config['o_regular_commission_value'] ?>" /></span>
						</div>
					</div>
				</fieldset>
				...
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
						<div class="sf-box frm-short text">
							<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_admin_settings['Problem commision value'] ?></span><small><?php echo $lang_admin_settings['Problem commision value help'] ?></small></label><br />
							<span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[problem_commission_value]" size="5" maxlength="3" value="<?php echo $forum_config['o_problem_commission_value'] ?>" /></span>
						</div>
					</div>
<?php ($hook = get_hook('aop_setup_pre_pagination_fieldset_end2')) ? eval($hook) : null; ?>				
				</fieldset>
