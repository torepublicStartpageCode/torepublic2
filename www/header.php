...
if ($forum_user['is_guest'])
	...
	//$price_of_one_bitcoin = $forum_config['btc_price_usd'];
	//$price_of_one_bitcoin2 = $forum_config['btc_price_pln'];
	//$visit_links['bitcoin_price']= '<span id="btc-price"'.(empty($visit_links) ? ' class="first-item"' : '').'>'.sprintf($lang_common['Bitcoin price'],round($price_of_one_bitcoin,0),round($price_of_one_bitcoin2,0)).'</span>';
