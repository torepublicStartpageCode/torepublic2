...
$forum_url = array(
	...
	'escrow'						=>	'escrows.php?action=start_new_escrow&user_id=$1',
	'buy_now'						=>	'escrows.php?action=start_new_escrow&amp;user_id=$1&amp;price=$2&amp;subject=$3',
	...
	'blog_add'						=>	'moderate.php?fid=$1&amp;blog_add=$2&amp;csrf_token=$3',	
	'blog_remove'					=>	'moderate.php?fid=$1&amp;blog_remove=$2&amp;csrf_token=$3',		
